...
const db = mysql.createPool({
    host: "localhost", // Adresse de votre serveur MariaDB
    user: "root", // Votre utilisateur MariaDB
    password: "root", // Votre mot de passe MariaDB
    database: "déploiement", // Nom de votre base de données
...
setInterval(async function () {
    try {
        ...
        const sql = `
            ...
            VALUES (?, ?, ?)
        `;
        const values = [valeur, 10, 1]; // a changer en fonction de l'ID variabel que l'on cherche+ ID-automate
